...
class RustEx extends StatefulWidget {
  const RustEx({super.key});

  @override
  State<RustEx> createState() => _RustEx();
}
...
Avec plein de baratins.
Ainsi que des boutons preview et pour la doc
Ou alors les mettre dans la barre de status.
En tout cas je suis en pleine forme.
Cet editor est une catastrophe.
La hauteur de la boite n'est pas assez haute.
En tout cas ca m'a l'air pas trop mal.
Ya juste a esperer que ca scroll correctement.
Etc... Etc...
La plume du chapeau de ma tante
est plus petite que le jardin de mon oncle
'''),
...
///
class _RustEx extends State<RustEx> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Rust Examples'),
      ),
      body: makeBody(),
